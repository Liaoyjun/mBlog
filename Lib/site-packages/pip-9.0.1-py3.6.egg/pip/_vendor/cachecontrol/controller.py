...
class CacheController(object):
    ...
    def cache_response(self, request, response, body=None):
        ...
        # If we've been given a text, our response has a Content-Length, that
        # Content-Length is valid then we can check to see if the text we've
    ...
    def update_cached_response(self, request, response):
        ...
        # the cached text invalid. But... just in case, we'll be sure
